...
3. You can select a Class to see a dialog pop up show all the Class dates and available spots.
...
8. You can unregister from a Class, but keep in mind that you will not be able to register to that perticular Class again. Sorry for this inconvenice.
