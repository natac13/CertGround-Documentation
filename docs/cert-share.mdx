---
name: Certifcation Share
path: /certifcation-share
---
...
- You will select your Courses like above but will be required to enter in the emial address of the person getting the Course Certificate Verification.
...
- The Email Cert Share is limited to 3 email per week. This is to maintain usage limits and incourage the use of the QRCode Cert Share.
